...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mapStyles = { dark: openStreetMapStyle, light: openStreetMapStyle, black: openStreetMapStyle };
    ...
    const mapController = {
        ...
        setupLayers: () => {
            // CORRECCIÓN: Se define un color negro fijo para la línea de grabación en vivo.
            const liveRouteColor = '#000000';

            // Los colores para las rutas guardadas y otros elementos pueden seguir dependiendo del tema.
            ...
            map.addLayer({ 
                ...
                paint: { 
                    'line-color': liveRouteColor, // Usar el color negro fijo
                    'line-width': 4 
                } 
            });
